# -*- coding: utf-8 -*-
#------------------------------------------------------------
# pld.visiontv (juarrox@gmail.com)
...
def novamov(params):
    ...
    if "This file no longer exists on our servers" in data:
        xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('pld.visiontv', "No existe vídeo en Novamov", 3 , art+'icon.png'))
    elif "is being converted" in data:
        xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('pld.visiontv', "Vídeo no disponible", 3 , art+'icon.png'))
